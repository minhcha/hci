...
<div class="contact-info">
    <div class="content">
        ...
        <p>Tổng đài tư vấn, hỗ trợ khách hàng (7h30 đến 22h): <span class="tel">0333 22 7624</span></p>
        <p>Tổng đài khiếu nại: <span class="tel">0333 22 7624</span></p>
        <p>Email: <a href="mailto:caoxuanthang1221@gmail.com">caoxuanthang1221@gmail.com</a></p>
    </div>
    <div class="with-map clearfix">
        <div class="company-address-wrapper">
            <div class="company-name">Công Ty Bán Lẻ Sản Phẩm Điện Tử</div>
            <div class="company-address">
                <p>Địa chỉ Đăng ký kinh doanh: 1 Võ Văn Ngân, P. Linh Chiểu, Q9, TP HCM</p>
                <p>Điện thoại: <span class="tel">0333 22 7624</span></p>
                <p>Fax: <span class="tel">0333 22 7624</span></p>
            </div>
        </div>
